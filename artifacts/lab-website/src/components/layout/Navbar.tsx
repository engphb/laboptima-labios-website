      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
        <a href="/" className="flex items-center gap-2 group">
          ...
          <div className="leading-tight">
            <span className={`font-display font-bold text-xl tracking-tight block transition-colors duration-300 ${
              ...
              LaBioS <span className={`font-light ${useDark ? "text-slate-400" : "text-white/50"}`}>|</span> LabOPTIMA
            </span>
                ...
                {isActive && (
                  <motion.div
                    ...
                    className={`absolute inset-0 rounded-full -z-10 ${
                      useDark ? "bg-primary/10" : "bg-white/10"
                    }`}
        ...
        <button
          className={`lg:hidden p-2 transition-colors ${
            useDark ? "text-slate-700 hover:text-primary" : "text-white hover:text-white/80"
          }`}
